                        ...
                        <?php foreach ($listdata as $row) { ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <img src="<?php echo BASEURL."/assets/uploads/blogs/".$row["header_image"]; ?>" height="70" width="70" /> 
                                </td>
                                <td class="text-center">
                                ...
                                <td style="text-align: center;">
                                    <a href="/blog/edit/<?php echo $row["blog_id"]; ?>"><i class="fa fa-pencil fa-lg"></i></a>&nbsp;&nbsp;&nbsp;
                                    <a href="#myModal" role="button" data-id="<?php echo $row["blog_id"]; ?>" data-toggle="modal"><i class="fa fa-trash-o fa-lg"></i></a>
                                </td>
                            </tr>
                        <?php } ?>
                    <?php } ?>
